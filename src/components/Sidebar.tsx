...
import { Settings, Video, ListTodo, Sparkles, Moon, Sun, HelpCircle, Keyboard } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ activeTab, onTabChange, runningCount = 0, theme = 'light', onToggleTheme, onOpenOnboarding, onOpenShortcuts }) => {
  const menuItems = [
  ...
  return <aside className="app-sidebar">
    <div className="sidebar-brand"><div className="sidebar-brand__mark"><Sparkles className="w-5 h-5" /></div><div><h1>AIVideoForge</h1><p>多平台 AI 视频生成工作台</p></div></div>
